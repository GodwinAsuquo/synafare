  ...
  return (
    <section>
      <div className="relative w-full h-screen md:h-[820px]">
        ...
        <div className="absolute text-white left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 ">
          <div className="w-[80%] mx-auto text-center space-y-10">
            ...
            <div className="flex space-x-5 mx-auto w-fit text-sm">
              <button className="text-primary bg-white py-2 px-3 rounded-lg border-2 border-white">
